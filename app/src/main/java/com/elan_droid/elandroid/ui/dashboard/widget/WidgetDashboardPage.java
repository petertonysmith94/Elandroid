 ...
 *
 * TODO: implement into page/WidgetPage
 */
public class WidgetDashboardPage extends Fragment implements View.OnTouchListener, View.OnLongClickListener {
    ...
    public static Fragment getInstance(DetailedPage page) {
        ...
        Fragment fragment = new WidgetDashboardPage();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mLayout = view.findViewById(R.id.dashboard_page_root);
