...
public class ProfileAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static class ProfileViewHolder extends RecyclerView.ViewHolder {
        ...
        ProfileViewHolder (View view) {
            ...
            mmActiveGlow = view.findViewById(R.id.list_item_profile_active);
            mmProfileName = view.findViewById(R.id.list_item_profile_name);
            mmProfileMakeModel = view.findViewById(R.id.list_item_profile_make_model);
            mmProfileRegistration = view.findViewById(R.id.list_item_profile_registration);
        }
