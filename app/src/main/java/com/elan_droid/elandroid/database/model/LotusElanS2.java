...
public class LotusElanS2 implements PrepopulateModel {
    ...
    private static class DiagnosticCommand extends Command {
        ...
        private static final Parameter[] PARAMETERS = {
                new FormattedParameter(MESSAGE_ID, "PROM_ID", "Prom ID", 0, 2, Parameter.MULTIPLIER_DEFAULT, Parameter.OFFSET_DEFAULT, "%u", Parameter.UNIT_NONE, false),
                new ParameterBitwise8(MESSAGE_ID, "FAULTS_1", "Faults", 2, new String[]{"VSS", "MAT low", "TPS low", "TPS high", "CTS low", "CTS high", "Oxygen sensor", "No ref. pulses"}),
                ...
                new FormattedParameter(MESSAGE_ID, "COOL_TEMP", "Coolant temp", 5, 1, 0.75, -40.0, "%5.1f", Parameter.UNIT_DEGREE_C, false),
                new FormattedParameter(MESSAGE_ID, "COOL_RAW", "Coolant raw", 6, 1, Parameter.MULTIPLIER_DEFAULT, Parameter.OFFSET_DEFAULT, "%5.1f", Parameter.UNIT_NONE, false),
                //old UnusedParameter(MESSAGE_ID, 7, 1),
                new FormattedParameter(MESSAGE_ID, "TPS_VOLTS", "TPS voltage", 8, 1, 0.02, Parameter.OFFSET_DEFAULT, "%5.2f", Parameter.UNIT_VOLTS, false),
                new FormattedParameter(MESSAGE_ID, "THROTTLE", "Throttle", 9, 1, 0.392157, Parameter.OFFSET_DEFAULT, "%5.1f", Parameter.UNIT_PERCENT, false),
                new FormattedParameter(MESSAGE_ID, "ENGINE_SPEED", "Engine speed", 10, 1, 25.0, Parameter.OFFSET_DEFAULT, "%5.1f", Parameter.UNIT_RPM, false),
                ...
                new FormattedParameter(MESSAGE_ID, "DRP_INTERVAL", "DRP interval", 12, 2, 0.01526, Parameter.OFFSET_DEFAULT, "%5.1f", Parameter.UNIT_MSEC, false),
                new FormattedParameter(MESSAGE_ID, "SPARK_ADVANCE", "Spark advance", 14, 2, 0.351562, Parameter.OFFSET_DEFAULT, "%5.1f", Parameter.UNIT_DEGREES, true),  //SIGNED
                new FormattedParameter(MESSAGE_ID, "SPEED", "Speed", 16, 1, Parameter.MULTIPLIER_DEFAULT, Parameter.OFFSET_DEFAULT, "%5.1f", Parameter.UNIT_MPH, false),
                new FormattedParameter(MESSAGE_ID, "CO_POTENTIOMETER", "CO potentiometer", 17, 1, 0.019608, Parameter.OFFSET_DEFAULT, "%5.1f", Parameter.UNIT_VOLTS, false), //TO BE DETERMINTED
                new FormattedParameter(MESSAGE_ID, "OXYGEN_SENSOR", "Oxygen sensor (integrator)", 18, 1, Parameter.MULTIPLIER_DEFAULT, Parameter.OFFSET_DEFAULT, "%x", Parameter.UNIT_NONE, false),
                ...
                new FormattedParameter(MESSAGE_ID, "IAC_POSITION", "IAC position", 20, 1, Parameter.MULTIPLIER_DEFAULT, Parameter.OFFSET_DEFAULT, "%5.1f", Parameter.UNIT_NONE, false),
                new FormattedParameter(MESSAGE_ID, "TARGET_IDLE", "Target idle", 21, 1, 12.5, Parameter.OFFSET_DEFAULT, "%5.1f", Parameter.UNIT_RPM, false),
                new FormattedParameter(MESSAGE_ID, "BAROMETER", "Barometer", 22, 1, 0.00781, 0.08, "%5.2f", Parameter.UNIT_BAR, false),
                new FormattedParameter(MESSAGE_ID, "MANIFOLD_PRESSURE_ABS", "Manifold press (ABS)", 23, 1, 0.00781, 0.08, "%5.2f", Parameter.UNIT_BAR, false),
                new FormattedParameter(MESSAGE_ID, "FLAG_25", "Flag 25", 24, 1, Parameter.MULTIPLIER_DEFAULT, Parameter.OFFSET_DEFAULT, "%5.1f", Parameter.UNIT_NONE, false),
                new FormattedParameter(MESSAGE_ID, "BATTERY_VOLTAGE", "Battery voltage", 25, 1, 0.1, Parameter.OFFSET_DEFAULT, "%5.1f", Parameter.UNIT_VOLTS, false),
                new FormattedParameter(MESSAGE_ID, "INJECTOR_PULSE_WIDTH", "Injector pulse width", 26, 2, 0.007629, Parameter.OFFSET_DEFAULT, "%5.1f", Parameter.UNIT_MSEC, false),
                new FormattedParameter(MESSAGE_ID, "OXYGEN_SENSOR_INTEGRATOR", "Oxygen sensor (integrator)", 28, 1, Parameter.MULTIPLIER_DEFAULT, Parameter.OFFSET_DEFAULT, "%x", Parameter.UNIT_NONE, false),
                ...
                new FormattedParameter(MESSAGE_ID, "ENGINE_RUN_TIME", "Engine run time", 30, 2, Parameter.MULTIPLIER_DEFAULT, Parameter.OFFSET_DEFAULT, "%5.1f", Parameter.UNIT_SECONDS, false),
                new FormattedParameter(MESSAGE_ID, "AIR_FUEL_RATIO", "Air/fuel ratio", 32, 1, 0.1, Parameter.OFFSET_DEFAULT, "%5.1f", Parameter.UNIT_NONE, false),
                ...
                new FormattedParameter(MESSAGE_ID, "VOLTAGE_COMP", "Voltage comp???", 36, 1, 0.05, Parameter.OFFSET_DEFAULT, "%5.1f", Parameter.UNIT_VOLTS, false),
                ...
                new FormattedParameter(MESSAGE_ID, "WASTEGATE_DUTY_CYCLE", "Wastegate duty cycle", 40, 1, 0.390625, Parameter.OFFSET_DEFAULT, "%5.1f", Parameter.UNIT_PERCENT, false),
                ...
                new FormattedParameter(MESSAGE_ID, "KNOCK_COUNTER", "Knock counter", 43, 1, Parameter.MULTIPLIER_DEFAULT, Parameter.OFFSET_DEFAULT, "%5.1f", Parameter.UNIT_NONE, false),
                new FormattedParameter(MESSAGE_ID, "KNOCK_RETARD", "Knock retard", 44, 1, 0.176470588235294, Parameter.OFFSET_DEFAULT, "%5.1f", Parameter.UNIT_DEGREES, false),
                ...
                new FormattedParameter(MESSAGE_ID, "MAT", "MAT", 46, 1, -0.549, 130.0, "%5.1f", Parameter.UNIT_DEGREE_C, false),
                ...
                new FormattedParameter(MESSAGE_ID, "FLAG_53", "Flag 53", 52, 1, Parameter.MULTIPLIER_DEFAULT, Parameter.OFFSET_DEFAULT, "%5.1f", Parameter.UNIT_NONE, false),
                ...
                new FormattedParameter(MESSAGE_ID, "FLAG_56", "Flag 56", 55, 1, Parameter.MULTIPLIER_DEFAULT, Parameter.OFFSET_DEFAULT, "%5.1f", Parameter.UNIT_NONE, false),
                ...
                new FormattedParameter(MESSAGE_ID, "OP_TEMP", "Operation temp", 60, 1, Parameter.MULTIPLIER_DEFAULT, Parameter.OFFSET_DEFAULT, "%5.1f", Parameter.UNIT_DEGREE_C, false),
