...
public class ParameterFormatted extends ParameterStream {
    ...
    // TODO: change to custom Unit class so user can change
    ...
    public static class ListViewHolder extends ListPage.ParameterAdapter.BaseViewHolder {
        ...
        public ListViewHolder(View view) {
            ...
            paramName = view.findViewById(R.id.list_item_formatted_parameter_title);
            packetValue = view.findViewById(R.id.list_item_formatted_packet_value);
            paramUnits = view.findViewById(R.id.list_item_formatted_parameter_units);
        }
